 ...
 */
public class MyFlutterBluetoothPrinterPlugin implements FlutterPlugin{
    ...
    private static final String FLUTTER_TO_ANDROID_CHANNEL = "my_flutter_bluetooth_printer";
